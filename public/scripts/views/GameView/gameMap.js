...
pug_html = pug_html + "\u003Cdiv style=\"width:20px; height:20px; background-color:coral;position:absolute;left:270\" id=\"player-2\"\u003E\u003C\u002Fdiv\u003E";
;pug_debug_line = 155;pug_debug_filename = "gameMap.pug";
pug_html = pug_html + "\u003Cdiv style=\"width:20px;height:20px;background-color:chartreuse;position:absolute;top:618;left:270\" id=\"player-1\"\u003E\u003C\u002Fdiv\u003E\u003C\u002Fsection\u003E";} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}